        ...
        <div class="container">
            ...
            <form action="accountLogic/editAccount.php?<?= $id ?>" method="POST">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nom" name="nom" placeholder="Nom du membre" value="<?= isset($nom) ? $nom : '' ?>" required>
                </div>
                <div class="mb-3">
                    <label for="prenom" class="form-label">Prénom</label>
                    <input type="text" class="form-control" id="prenom" name="prenom" placeholder="Prénom du membre" value="<?= isset($prenom) ? $prenom : '' ?>" required>
                </div>
                <div class="mb-3">
                    <label for="telephone" class="form-label">Teléphone</label>
                    <input type="text" class="form-control" id="telephone" name="telephone" placeholder="Téléphone du membre" value="<?= isset($telephone) ? $telephone : '' ?>" required>
                </div>
                <div class="mb-3">
                    <label for="mail" class="form-label">Email</label>
                    <input type="email" class="form-control" id="mail" name="mail" placeholder="user@user.com" value="<?= isset($mail) ? $mail : '' ?>" required>
                </div>
