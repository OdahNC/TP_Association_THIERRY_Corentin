                    ...
                    <div class="card-body">
                        ...
                        <form action="connectionLogic/sign_up_logic.php" method="POST" onsubmit="return checkInformations()">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="user_firstname" name="user_firstname" placeholder="Votre nom">
                            </div>
                            <div class="mb-3">
                                <label for="user_lastname" class="form-label">Votre prénom</label>
                                <input type="text" class="form-control" id="user_lastname" name="user_lastname" placeholder="Votre prénom">
                            </div>
                            <div class="mb-3">
                                <label for="user_phone" class="form-label">Votre numéro de téléphone</label>
                                <input type="tel" class="form-control" id="user_phone" name="user_phone" placeholder="00.00.00">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" id="confirm_user_password" name="confirm_user_password" placeholder="Confirmez votre mot de passe">
